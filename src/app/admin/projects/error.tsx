...
/**
 * Catches render-time crashes in the project list so a bug in one card shows
 * a recoverable message instead of a blank admin screen. Fetch failures never
 * reach here — the page itself catches those and renders AdminNotice — this
