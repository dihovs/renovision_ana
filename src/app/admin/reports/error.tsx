...
/**
 * Catches render-time crashes while computing the reports. Fetch and
 * migration failures never reach here — the page itself catches those and
 * renders AdminNotice — this is only for the unexpected.
 */
  ...
  return (
    <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 text-sm leading-relaxed text-charcoal/70">
        Nothing was lost — quotes and invoices are unaffected. Try again, and if it keeps
