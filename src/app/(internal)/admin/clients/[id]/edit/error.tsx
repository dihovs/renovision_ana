...
/**
 * Catches crashes loading the edit form — most commonly a database blip
 * fetching tax rates, lead sources, or custom field definitions.
 */
  ...
  return (
    <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 text-sm leading-relaxed text-charcoal/70">
        Nothing was changed. Try again, and if it keeps happening let the office know.
      </p>
      <button
        type="button"
