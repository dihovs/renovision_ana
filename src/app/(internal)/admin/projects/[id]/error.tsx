...
/** Recoverable message for render-time crashes on a project's detail page. */
  ...
  return (
    <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 text-sm leading-relaxed text-charcoal/70">
        Nothing was lost — the files are safe in storage. Try again, and if it keeps happening
        let the office know.
      </p>
      <button
        type="button"
