...
/**
 * Fallback for the customer's copy of an invoice.
 *
 * Same rule as the public quote's boundary: the error can fire before the page
 * ever resolves `invoice.language`, so both languages are shown together
 * rather than guessing wrong in front of a customer.
 */
    ...
    <main className="flex min-h-dvh items-center justify-center bg-[#f6f8fb] px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border border-black/5 bg-white p-6 text-center shadow-sm sm:p-8">
        ...
        <p className="mt-2 text-sm leading-relaxed text-charcoal/65">
          Nous n&apos;avons pas pu afficher cette facture. Veuillez réessayer, ou nous contacter si
          le problème persiste.
        </p>
        <p className="mt-1 text-sm leading-relaxed text-charcoal/65">
          We couldn&apos;t display this invoice. Please try again, or contact us if the problem
          continues.
        </p>
        <button
          type="button"
