    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Anthropic — powers the estimate chat. What you type into the chat is sent to their service to generate a reply.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Anthropic — fait fonctionner le clavardage d'estimation. Ce que vous écrivez dans le clavardage est transmis à leur service pour générer une réponse.",
