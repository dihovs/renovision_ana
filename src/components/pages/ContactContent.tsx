...
const copy = {
  en: {
    ...
    emergencyNote: "Water damage emergency? Our line is answered 24/7 — any hour, any day of the year.",
  ...
  fr: {
    ...
    emergencyNote: "Urgence de dégât d'eau? Notre ligne est répondue 24/7 — à toute heure, tous les jours de l'année.",
