...
export type Review = {
  ...
  text: string;  /** Their own Google profile photo, if they set one. Letter-tile defaults are left out — the card draws its own initial. */
  avatar?: string;
};
...
export const googleReviews: { rating: number | null; count: number | null; items: Review[] } = {
  ...
  items: [
    ...
    { author: "Yael A.", avatar: "/slk/reviews/yael-a.jpg", rating: 5, lang: "en", text: "Came back to see Armine after a couple years. Still an amazing experience with results that show. She’s very knowledgeable and professional and knows what she’s doing. And you don’t need to spend 10k like in luxury spas. Her methods deliver results for reasonable pricing and personalized experience. 🩷" },
    ...
    { author: "Marie-Pier L.G.", avatar: "/slk/reviews/marie-pier-l-g.jpg", rating: 5, lang: "en", text: "My skin DRASTICALLY improved after seeing Armine. Like most people, I had grown up being told the wrong way to take care of skin and had so much accumulated dead skin, which caused dark circles and a skin tone that required makeup daily to look 'healthy'. Since the first treatment, my skin tone has improved so much that I have not worn concealer nor foundation! I have returned for yearly dead skin removal (since I don't drink enough water to stop accumulating dead skin 🙈) and I will always recommend Armine's services to all!" },
    { author: "Samantha C.", avatar: "/slk/reviews/samantha-c.jpg", rating: 5, lang: "en", text: "I had an amazing experience with Armine for my facial. She was so informative and kept reassuring my concerns even after me continuously repeating them. She also answered all my questions the days after my facial: My skin has fully healed and it feels/looks amazing. The texture has improved, fine lines have diminished, hyperpigmentation reduced and I feel much more confident in my skin. I highly recommend her for your facial needs. She is amazing. Thank you X a million." },
    { author: "Siham C.", avatar: "/slk/reviews/siham-c.jpg", rating: 5, lang: "fr", text: "Super expérience ! Le soin du visage était très agréable et parfaitement adapté à ma peau. L’esthéticienne est professionnelle, et de très bon conseil. Ma peau est éclatante et reposée. Je recommande vivement !" },
    { author: "Shannon C.", avatar: "/slk/reviews/shannon-c.jpg", rating: 5, lang: "en", text: "Great place for body treatments and real results. Not the cheap machines. Also qualified for advanced facial treatments ! Recommend 💯" },
  ...
  fr: {
    ...
    results: {
      ...
      peau: [
        ...
        { src: "/slk/instagram/04-peeling-before-after-acne-full.jpg", alt: "Avant / après peeling chimique — peau avec acné" },
        { src: "/slk/instagram/06-peeling-before-after-eyes-full.jpg", alt: "Avant / après peeling chimique — contour des yeux" },
      ],
      corps: [
  ...
  en: {
    ...
    results: {
      ...
      peau: [
        ...
        { src: "/slk/instagram/04-peeling-before-after-acne-full.jpg", alt: "Chemical peel before/after — acne-prone skin" },
        { src: "/slk/instagram/06-peeling-before-after-eyes-full.jpg", alt: "Chemical peel before/after — eye area" },
      ],
      corps: [
